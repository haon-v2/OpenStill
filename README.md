...
- Crop: draw a rectangle and Apply crop; rotate, flip, or reset. Straighten manually (−20° to +20°) or choose **AI align horizon** for local Apple Vision detection. Straightening automatically fills the frame without empty corners. If no confident tilted horizon is found, the photo stays unchanged. Escape ends a drawing tool.
