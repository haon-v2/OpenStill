...
- User-supplied car JPEG and 12 authorized JPEG copies from the Arda conversation
  used locally; no messages sent. These shared JPEGs lack camera/lens EXIF and
...
`/Users/noahhelms/Applications/OpenStill.app` and launched successfully with the
user's 24MP car JPEG. Final native sidebar and compact Shoot toolbar inspected.
